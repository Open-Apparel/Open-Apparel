...
const rawDesigns = {
	...
	'selectively-social': {
		name: 'Selectively Social',
		description:
			"Say it loud and clear without saying a word. This design is perfect for those days when you're choosing your company wisely.",
		downloads: [
			{
				name: 'selectively-social.svg',
				url: '/selectively-social.svg'
			}
		],
		pictures: [],
		authors: [AUTHORS.borisnl]
